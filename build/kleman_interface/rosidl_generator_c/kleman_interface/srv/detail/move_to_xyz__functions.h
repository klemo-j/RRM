...
#ifndef KLEMAN_INTERFACE__SRV__DETAIL__MOVE_TO_XYZ__FUNCTIONS_H_
#define KLEMAN_INTERFACE__SRV__DETAIL__MOVE_TO_XYZ__FUNCTIONS_H_
 ...
 * )) before or use
 * kleman_interface__srv__MoveToXYZ_Request__create()
 ...
 * calls
 * kleman_interface__srv__MoveToXYZ_Request__init().
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Request__fini()
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * kleman_interface__srv__MoveToXYZ_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kleman_interface__srv__MoveToXYZ_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * kleman_interface__srv__MoveToXYZ_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * kleman_interface__srv__MoveToXYZ_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
...
/**
 * It allocates the memory for the array and calls
 * kleman_interface__srv__MoveToXYZ_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_kleman_interface
...
/**
 * It calls
 * kleman_interface__srv__MoveToXYZ_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // KLEMAN_INTERFACE__SRV__DETAIL__MOVE_TO_XYZ__FUNCTIONS_H_
